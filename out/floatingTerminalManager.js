...
exports.FloatingTerminalManager = void 0;
const vscode = require("vscode");
class FloatingTerminalManager {
    constructor(context) {
    ...
    createNew() {
        ...
        vscode.window.showInformationMessage(`Created new floating terminal (${this.terminals.length} total)`, { modal: false });
    }
    closeCurrent() {
...
- Status bar integration showing terminal count
    ...
    createOrShowWebview() {
        ...
        this.webviewPanel = vscode.window.createWebviewPanel('floatingTerminal', `Floating Terminal (${this.currentTerminalIndex + 1}/${this.terminals.length})`, {
...
exports.FloatingTerminalManager = FloatingTerminalManager;
//# sourceMappingURL=floatingTerminalManager.js.map